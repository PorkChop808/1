    ...
    with mss.mss() as sct:
        ...
        while bot_running:
            ...
            if detected_classes:
                ...
                # Hold left mouse if 'danger_left' is detected (even if 'danger_right' is also detected)
                if 'danger_left' in detected_classes:
                    if not holding_left:
                        pyautogui.mouseDown(button='left')
                        holding_left = True
                # Release left mouse only if 'danger_left' is NOT detected and 'danger_right' is detected
